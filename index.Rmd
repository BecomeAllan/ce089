...
- **Curso:** Estatística
- **Período:** segundo semestre de 2020 (período especial, iniciado em
  maio de 2021)
- **Professor Responsável:**
  - [Fernando de Pol Mayer][], [LEG][]/DEST/UFPR
  <!-- - [Walmes Marques Zeviani][], [LEG][]/DEST/UFPR -->
- **Horários e Locais:**
  - Quarta, 21:00 - 22:30h, **Teams**
  - Sexta, 19:00 - 20:30h, **Teams**
...
- **Avaliação**:
  - A nota na disciplina será formada pelo desempenho médio (0 – 100) na
    realização de 5 avaliações
  - Para mitigar eventuais problemas de conexão e ambientação, a menor
    nota dentre as 5 avaliações será desconsiderada para o cálculo do
    desempenho médio.
...
- **Moodle:** [Página no
  Moodle](https://ufprvirtual.ufpr.br/course/view.php?id=18647) da
  dsiciplina
- **Datas importantes:**
    - **19/05/21**: Início das aulas
    - **30/07/21**: Final das aulas
    - **13/08/21**: Exame final
