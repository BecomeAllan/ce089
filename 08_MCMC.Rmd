...
knitr::include_url("animation/MH_sampler_beta_unif.html", height = "735px")
```

<!-- Tem o outro exemplo da beta -->
...
```{r, echo=FALSE, results='asis', out.extra='style="display:block; margin: auto;" frameborder="0"'}
knitr::include_url("animation/MH_RW_normal_unif.html", height = "715px")
```
...
```{r, echo=FALSE, results='asis', out.extra='style="display:block; margin: auto;" frameborder="0"'}
knitr::include_url("animation/MH_IID_beta_unif.html", height = "715px")
```
...
```{r, echo=FALSE, results='asis', out.extra='style="display:block; margin: auto;" frameborder="0"'}
knitr::include_url("animation/MH_IID_beta_normal.html", height = "715px")
```
